...
public class DeleteMyGroupSelectCommand implements Command {
    private final String forCallback= "DelGroup-";
    private final SendBotMessageService sendBotMessageService;
    private final ModifyDataBaseService modifyDataBaseService;

    public DeleteMyGroupSelectCommand(SendBotMessageService sendBotMessageService, ModifyDataBaseService modifyDataBaseService) {
    ...
    public void execute(Update update) {
        ...
        String response = modifyDataBaseService.dropGroup(nameGroup,chatId);
